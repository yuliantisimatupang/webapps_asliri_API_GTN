...
def inputform() {
    ...
    'wait result appear'
    WebUI.waitForElementPresent(findTestObject('Web/CWS/Verify Phone/div_InformationFailed create order'), 2)

    WebUI.delay(2)

    'result verify phone'
    WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify Phone/div_InformationFailed create order'), 2)
