...
'Mapping Excel File'
nameTestData = 'Verify/Verify Biometric 3 User'
...
CustomKeywords.'abstraction.loginCW.login'('febry1@mail.com', 'M@sukg4n')

WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify/Checkbox Biometric Verification'), 1)
WebUI.click(findTestObject('Web/CWS/Verify/Checkbox Biometric Verification'))
WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify/Checkbox Agreement'), 1)
WebUI.click(findTestObject('Web/CWS/Verify/Checkbox Agreement'))
WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify/button_Submit'), 1)
...
def inputform() {
	...
	WebUI.verifyMatch(FilePath, 'C:\\fakepath\\Junius Besar.jpg', false)
	...
	WebUI.verifyMatch(FilePath2, 'C:\\fakepath\\NPWP Junius.jpeg', false)
