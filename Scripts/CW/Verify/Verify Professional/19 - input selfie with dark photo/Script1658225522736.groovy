...
def inputform() {
	...
	WebUI.scrollToElement(findTestObject('Web/CWS/Verify Professional/success message'), 2)
	
	WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify Professional/success message'), 2)
