...
def inputform() {
    ...
    'result verify profesional'
    WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify Professional/result Verify Professional'), 2)

    WebUI.delay(3)
	
	WebUI.scrollToElement(findTestObject('Web/CWS/Verify Professional/error no face detected'), 2)
	
	WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify Professional/error no face detected'), 2)
