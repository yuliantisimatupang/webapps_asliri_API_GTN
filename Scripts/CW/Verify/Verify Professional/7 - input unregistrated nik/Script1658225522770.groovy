...
def inputform() {
    ...
    WebUI.scrollToElement(findTestObject('Web/CWS/Verify Professional/error message data not found'), 2)

    WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify Professional/error message data not found'), 2)
