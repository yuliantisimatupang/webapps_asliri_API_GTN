...
def inputform() {
    ...
    WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify Workplace/icon centang'), 2)

    WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify Workplace/icon x'), 2)

    WebUI.verifyTextPresent('PPKH K*C*M*T*N S*Y*NG D*M*K', false)
