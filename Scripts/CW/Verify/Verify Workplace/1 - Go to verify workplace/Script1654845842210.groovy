...
'scroll to verify workplace'
WebUI.scrollToElement(findTestObject('Web/CWS/Verify/Checkbox Verify Workplace'), 2)

WebUI.delay(1)

if (WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify/Checkbox Verify Workplace'), 2, FailureHandling.STOP_ON_FAILURE)) {
...
def gotoverifyworkplace() {
    WebUI.delay(1)

    'click checkbox verify workplace'
    WebUI.check(findTestObject('Web/CWS/Verify/Checkbox Verify Workplace'))

    'verify element checked'
    WebUI.verifyElementChecked(findTestObject('Web/CWS/Verify/Checkbox Verify Workplace'), 2)
