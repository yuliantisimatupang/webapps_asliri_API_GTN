...
def inputform() {
	...
	WebUI.verifyMatch(FilePath, 'C:\\fakepath\\jeli.webp', false)
	...
	'confirm result'
	WebUI.waitForElementPresent(findTestObject('Web/CWS/Verify Biometric Plus/div_error_selfie_photo'), 1)
	WebUI.scrollToElement(findTestObject('Web/CWS/Verify Biometric Plus/input_name'), 1)
	WebUI.delay(1)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/div_error_selfie_photo')), 'The selfie must be a file of type: jpeg, jpg, png.', false)
