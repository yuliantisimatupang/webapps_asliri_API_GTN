...
def inputform() {
	...
	WebUI.verifyMatch(FilePath, 'C:\\fakepath\\febry_7MB.jpg', false)
	...
	WebUI.delay(1)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/div_error_selfie_photo')), 'File upload must be less than 2MB', false)
