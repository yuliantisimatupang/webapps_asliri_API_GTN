...
def inputform() {
	...
	WebUI.verifyMatch(FilePath2, 'C:\\fakepath\\febry_7MB.jpg', false)
	...
	WebUI.verifyMatch(FilePath3, 'C:\\fakepath\\febry_7MB.jpg', false)
	...
	WebUI.verifyMatch(FilePath4, 'C:\\fakepath\\febry_7MB.jpg', false)
	...
	WebUI.verifyMatch(FilePath5, 'C:\\fakepath\\febry_7MB.jpg', false)
	...
	WebUI.verifyMatch(FilePath6, 'C:\\fakepath\\febry_7MB.jpg', false)
	...
	WebUI.verifyMatch(FilePath7, 'C:\\fakepath\\febry_7MB.jpg', false)
	...
	WebUI.delay(1)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/div_error_npwp_photo')), 'File upload must be less than 2MB', false)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/div_error_sim_photo')), 'File upload must be less than 2MB', false)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/div_error_bpjs_tk_photo')), 'File upload must be less than 2MB', false)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/div_error_bpjs_kes_photo')), 'File upload must be less than 2MB', false)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/div_error_passport_photo')), 'File upload must be less than 2MB', false)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/div_error_files_photo')), 'File upload must be less than 2MB', false)
