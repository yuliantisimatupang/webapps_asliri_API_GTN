...
def inputform() {
	...
	nameStatus = WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/Result/span_name_percentage'))	
	pdobStatus = WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/Result/span_PDOB_percentage'))	
	addressStatus = WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/Result/span_address_hashout'))	
	mother_nameStatus = WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/Result/span_mother_name_percentage'))
	selfie_photoStatus = WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/Result/span_selfie_photo_percentage'))
	
	assert nameStatus == ''
	assert pdobStatus == ''
	assert addressStatus == ''
	assert mother_nameStatus == ''
	assert selfie_photoStatus == ''
