...
def inputform() {
	...
	WebUI.verifyMatch(FilePath, 'C:\\fakepath\\yehuda.png', false)
	...
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/Result/span_name_percentage')), '', false)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/Result/span_PDOB_percentage')), '', false)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/Result/span_address_hashout')), '', false)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/Result/span_mother_name_percentage')), '', false)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Biometric Plus/Result/span_selfie_photo_percentage')), '', false)
