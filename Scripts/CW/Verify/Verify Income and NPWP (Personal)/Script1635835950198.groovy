...
WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify/Checkbox Verify Income and NPWP (Personal)'), 0)

WebUI.click(findTestObject('Web/CWS/Verify/Checkbox Verify Income and NPWP (Personal)'))
...
WebUI.setText(findTestObject('Web/CWS/Verify Income and NPWP (Personal)/npwp_textField'), '2325436432323423')
