...
def gotoincomegrade() {
    ...
    'click verify income grade'
    WebUI.check(findTestObject('Web/CWS/Verify/Checkbox Verify Income Grade'))

    'verify element checked'
    WebUI.verifyElementChecked(findTestObject('Web/CWS/Verify/Checkbox Verify Income Grade'), 2)
