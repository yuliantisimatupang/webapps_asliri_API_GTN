...
WebUI.scrollToElement(findTestObject('Web/CWS/Verify/Checkbox Verify Basic Plus'), 1)

WebUI.delay(2)

if (WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify/Checkbox Verify Basic Plus'), 2, FailureHandling.STOP_ON_FAILURE)) {
    'go to basic plus'
    gotobasicplus()
} else {
    'close browser'
...
def gotobasicplus() {
    'click checkbox verify basic plus'
    WebUI.check(findTestObject('Web/CWS/Verify/Checkbox Verify Basic Plus'))

    WebUI.delay(1)

    'verify element checked'
    WebUI.verifyElementChecked(findTestObject('Web/CWS/Verify/Checkbox Verify Basic Plus'), 2)
