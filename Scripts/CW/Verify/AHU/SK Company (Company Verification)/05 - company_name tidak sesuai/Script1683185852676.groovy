...
def inputform() {
	...
	WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Web/CWS/AHU/Result/icon_decree_no'), 'class'), 'mdi mdi-close', false)
	
	WebUI.verifyElementPresent(findTestObject('Web/CWS/AHU/Result/icon_decree_date'), 1)
	WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Web/CWS/AHU/Result/icon_decree_date'), 'class'), 'mdi mdi-close', false)
