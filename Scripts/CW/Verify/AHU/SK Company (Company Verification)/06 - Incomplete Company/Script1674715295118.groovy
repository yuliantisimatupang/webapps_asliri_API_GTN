...
def inputform() {
	...
	'wait result appear'
	WebUI.waitForElementPresent(findTestObject('Web/CWS/AHU/SK Company//Result/result Company Verification'), 1)
	
	'confirm result'
	WebUI.verifyElementPresent(findTestObject('Web/CWS/AHU/Result/hashout INDOGOLD'), 1)
	
	WebUI.verifyElementPresent(findTestObject('Web/CWS/AHU/Result/0404'), 1)
