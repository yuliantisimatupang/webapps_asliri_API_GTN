...
WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify/Checkbox Company Verification'), 1)

WebUI.click(findTestObject('Web/CWS/Verify/Checkbox Company Verification'))
