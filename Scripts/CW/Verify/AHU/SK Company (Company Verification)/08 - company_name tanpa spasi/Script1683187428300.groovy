...
def inputform() {
	...
	WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Web/CWS/AHU/Result/icon_company_name'), 'class'), 'mdi mdi-minus', false)
	
	WebUI.verifyElementPresent(findTestObject('Web/CWS/AHU/Result/span_decree_no'), 1)
	WebUI.verifyMatch(WebUI.getAttribute(findTestObject('Web/CWS/AHU/Result/icon_decree_no'), 'class'), 'mdi mdi-minus', false)
