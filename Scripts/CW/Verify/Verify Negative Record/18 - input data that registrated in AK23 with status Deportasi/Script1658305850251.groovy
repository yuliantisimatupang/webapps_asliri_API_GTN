...
def inputform() {
    ...
    'Link appear\r\n'
    WebUI.scrollToElement(findTestObject('Web/CWS/Verify Negative Record/status'), 2)

    'Url\r\n'
    WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify Negative Record/status'), 2)

    'button link lihat url'
    WebUI.verifyTextPresent('Deportasi', true)
