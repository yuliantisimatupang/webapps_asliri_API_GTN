...
def inputform() {
    ...
    'Link appear\r\n'
    WebUI.scrollToElement(findTestObject('Web/CWS/Verify Negative Record/nomor perkara'), 2)

    'Url\r\n'
    WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify Negative Record/nomor perkara'), 2)
