...
if (WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify/Checkbox Verify Basic'), 2, FailureHandling.STOP_ON_FAILURE)) {
    'go to verify basic'
    gotoverifybasic()
} else {
    'close browser'
...
def gotoverifybasic() {
    ...
    'click verify basic'
    WebUI.check(findTestObject('Web/CWS/Verify/Checkbox Verify Basic'))

    'verify element checked'
    WebUI.verifyElementChecked(findTestObject('Web/CWS/Verify/Checkbox Verify Basic'), 2)
