...
WebUI.scrollToElement(findTestObject('Web/CWS/Verify/Checkbox Verify Total Associated Phone Number'), 0)

WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify/Checkbox Verify Total Associated Phone Number'), 0)

WebUI.click(findTestObject('Web/CWS/Verify/Checkbox Verify Total Associated Phone Number'))
