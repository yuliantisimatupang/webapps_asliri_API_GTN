...
WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify/Checkbox Verify Phone Number Lifetime'), 0)

WebUI.click(findTestObject('Web/CWS/Verify/Checkbox Verify Phone Number Lifetime'))
