...
def inputform() {
	...
	'confirm result'
	WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify Company Headcount/Result/span_company_name'), 1)
	WebUI.verifyMatch(WebUI.getText(findTestObject('Web/CWS/Verify Company Headcount/Result/span_company_name')), '80.95238 %', false)
