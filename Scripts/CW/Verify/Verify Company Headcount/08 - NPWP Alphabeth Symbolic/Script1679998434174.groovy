...
def inputform() {
	...
	'wait result appear'
	WebUI.waitForElementPresent(findTestObject('Web/CWS/Verify Company Headcount/div_The company npwp must be a number'), 1)
	
	'confirm result'
	WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify Company Headcount/div_The company npwp must be a number'), 1)
