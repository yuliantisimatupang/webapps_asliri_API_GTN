...
def inputform() {
	...
	'wait result appear'
	WebUI.waitForElementPresent(findTestObject('Web/CWS/Verify Company Ownership/div_The personal npwp must be 15 digits'), 1)
	
	'confirm result'
	WebUI.verifyElementPresent(findTestObject('Web/CWS/Verify Company Ownership/div_The personal npwp must be 15 digits'), 1)
